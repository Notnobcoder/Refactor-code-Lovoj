      ...
      >
        ...
        <FlexBetween paddingX={"8rem"} paddingY={"10rem"}>
          ...
          <Box display={"flex"} width={"40%"} justifyContent={"space-between"}>
            <Box>
              <LazyLoadImage src={ManufacturerLink} width={"30px"} />
              <Typography variant="h6" py={"2rem"}>
                Manufacturer
              </Typography>
            </Box>
            <Box>
              <LazyLoadImage src={WholeSalerLink} width={"30px"} />
              <Typography variant="h6" py={"2rem"}>
                Whole Saler
              </Typography>
            </Box>
            <Box>
              <LazyLoadImage src={RetailersLink} width={"30px"} />
              <Typography variant="h6" py={"2rem"}>
                Retailer
              </Typography>
            </Box>
          ...
          >
            ...
            >
              ...
              <MenuItem value={"Whole Saler"}>Whole Saler</MenuItem>
